    ...
    try {
      ...
      if (res.statusCode == 200) {
        ...
        if (responseBodyOfGetCurrentUserCartItems['success'] == true) {
          ...
          Fluttertoast.showToast(msg: "votre liste de panier est vide.");
        }
                    ...
                    onPressed: () async {
                      var responseFromDialogBox = await Get.dialog(
                        AlertDialog(
                          ...
                          content: const Text(
                              "Êtes-vous sûr de supprimer les articles sélectionnés de votre liste de panier ?"),
                          actions: [
                            TextButton(
                              onPressed: () {
                                Get.back();
                                        ...
                                        children: [
                                          ...
                                          Row(
                                            children: [
                                              ...
                                              Expanded(
                                                child: Text(
                                                  "Couleur: CFA{cartModel.color!.replaceAll('[', '').replaceAll(']', '')}" +
                                                      "\n" +
                                                      "Taille: ${cartModel.size!.replaceAll('[', '').replaceAll(']', '')}",
                                                  maxLines: 3,
                                                  overflow:
          ...
          return Container(
            ...
            child: Row(
              children: [
                ...
                Obx(
                  () => Text(
                    "\CFA " + cartListController.total.toStringAsFixed(2),
                    maxLines: 1,
                    style: const TextStyle(
