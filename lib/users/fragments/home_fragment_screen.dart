  ...
  Future<List<Clothes>> getTrendingClothItems() async {
    ...
    try {
      ...
      if (res.statusCode == 200) {
        ...
        Fluttertoast.showToast(msg: "Erreur, le code d'état n'est pas 200");
      }
    } catch (errorMsg) {
    ...
    return Padding(
      ...
      child: TextField(
        ...
        decoration: InputDecoration(
          ...
          hintText: "Recherchez les meilleurs vêtements ici...",
    ...
    return FutureBuilder(
      ...
      builder: (context, AsyncSnapshot<List<Clothes>> dataSnapShot) {
        ...
        if (dataSnapShot.data!.length > 0) {
          ...
          return const Center(
            child: Text("Vide, pas de données."),
          );
        }
      },
    );
