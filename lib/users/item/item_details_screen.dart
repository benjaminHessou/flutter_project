          ...
          200) //from flutter app the connection with api to server - success
      {
        ...
        if (resBodyOfAddCart['success'] == true) {
          Fluttertoast.showToast(
              msg: "article enregistré dans le panier avec succès.");
        } else {
          Fluttertoast.showToast(
              msg:
                  "Une erreur s'est produite. L'article n'a pas été enregistré dans le panier et réessayez.");
        }
      } else {
    ...
    try {
          ...
          200) //from flutter app the connection with api to server - success
      {
        ...
        if (resBodyOfAddFavorite['success'] == true) {
          Fluttertoast.showToast(
              msg:
                  "élément enregistré dans votre liste de favoris avec succès.");

          validateFavoriteList();
        } else {
          Fluttertoast.showToast(
              msg: "Article non enregistré dans votre liste de favoris.");
        }
      } else {
        Fluttertoast.showToast(msg: "Status is not 200");
      }
    ...
    try {
          ...
          200) //from flutter app the connection with api to server - success
      {
        ...
        if (resBodyOfDeleteFavorite['success'] == true) {
          Fluttertoast.showToast(
              msg: "élément supprimé de votre liste de favoris.");

          validateFavoriteList();
        } else {
          Fluttertoast.showToast(
              msg: "élément NON supprimé de votre liste de favoris.");
        }
      } else {
        Fluttertoast.showToast(msg: "Status is not 200");
      }
      ...
      body: Stack(
        children: [
          ...
          Positioned(
            ...
            right: 0,
            child: Container(
              color: Color.fromARGB(0, 42, 47, 48),
              child: Row(
                children: [
                  //back
                  IconButton(
                    ...
                    icon: const Icon(
                      Icons.arrow_back,
                      color: Color.fromARGB(255, 213, 236, 39),
                    ),
                  ),
                  ...
                  Obx(() => IconButton(
                        ...
                        icon: Icon(
                          ...
                          color: Color.fromARGB(255, 226, 235, 46),
                        ),
                      )),
                  ...
                  IconButton(
                    ...
                    icon: const Icon(
                      Icons.shopping_cart,
                      color: Color.fromARGB(255, 212, 242, 39),
                    ),
                  ),
                ],
              ),
  ...
  itemInfoWidget() {
    return Container(
      ...
      decoration: const BoxDecoration(
        color: Color.fromARGB(255, 74, 77, 77),
        ...
        child: Column(
          ...
          children: [
            ...
            Center(
              child: Container(
                ...
                decoration: BoxDecoration(
                  color: Color.fromARGB(255, 64, 251, 123),
                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                      ...
                      //price
                      Text(
                        "\CFA" + widget.itemInfo!.price.toString(),
                        style: const TextStyle(
                          fontSize: 24,
                          color: Color.fromARGB(245, 248, 246, 249),
                          fontWeight: FontWeight.bold,
                        ),
                      ),
                    ],
                      ...
                      IconButton(
                        onPressed: () {
                          if (itemDetailsController.quantity - 1 >= 1) {
                            ...
                            Fluttertoast.showToast(
                                msg:
                                    "La quantité doit être de 1 ou supérieure à 1");
                          }
                        },
                        icon: const Icon(
            ...
            const Text(
              ...
              style: TextStyle(
                fontSize: 18,
                color: Color.fromARGB(255, 201, 251, 64),
                fontWeight: FontWeight.bold,
              ),
            ),
            ...
            const Text(
              ...
              style: TextStyle(
                fontSize: 18,
                color: Color.fromARGB(255, 185, 251, 64),
                fontWeight: FontWeight.bold,
              ),
            ),
            const SizedBox(height: 8),
            ...
            const Text(
              ...
              style: TextStyle(
                fontSize: 18,
                color: Color.fromARGB(255, 229, 251, 64),
                fontWeight: FontWeight.bold,
              ),
            ),
            const SizedBox(height: 8),
            ...
            Material(
              elevation: 4,
              color: Color.fromARGB(255, 191, 224, 84),
