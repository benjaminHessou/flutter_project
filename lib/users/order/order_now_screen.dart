...
class OrderNowScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        backgroundColor: Colors.black,
        title: const Text("Commandez maintenant"),
        titleSpacing: 0,
      ),
      body: ListView(
        children: [
          ...
          Padding(
            ...
            child: Column(
              ...
              children: const [
                ...
                SizedBox(height: 2),
                Text(
                  'Numéro de compte de entreprise / ID: \nY87Y-HJF9-CVBN-4321',
                  style: TextStyle(
                    fontSize: 14,
          ...
          Padding(
            ...
            child: TextField(
              ...
              decoration: InputDecoration(
                hintText: 'importe quel numéro de contact..',
          ...
          Padding(
            ...
            child: TextField(
              ...
              decoration: InputDecoration(
                hintText: 'Toute note que vous souhaitez écrire au vendeur.',
                hintStyle: const TextStyle(
                  color: Colors.white24,
                ),
                border: OutlineInputBorder(
          ...
          Padding(
            ...
            child: Material(
              color: Color.fromARGB(255, 160, 163, 93),
              ...
              child: InkWell(
                ...
                child: Padding(
                  ...
                  child: Row(
                    children: [
                      Text(
                        "\CFA" + totalAmount!.toStringAsFixed(2),
                        style: const TextStyle(
                          color: Colors.white70,
                          fontSize: 20,
                          fontWeight: FontWeight.bold,
