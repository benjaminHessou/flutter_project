      ...
      if (res.statusCode == 200) {
        ...
        if (responseBodyOfAddNewOrder["success"] == true) {
          ...
          Fluttertoast.showToast(
              msg: "Error:: \nvotre nouvelle commande n'est PAS passée.");
        }
      }
    } catch (erroeMsg) {
    ...
    try {
      ...
      if (res.statusCode == 200) {
        ...
        if (responseBodyFromDeleteCart["success"] == true) {
          Fluttertoast.showToast(
              msg: "votre nouvelle commande a été passée avec succès.");
        ...
        child: Column(
          ...
          children: [
            ...
            const Padding(
              ...
              child: Text(
                "Veuillez joindre la transaction \nCapture d'écran de preuve / Image",
                  ...
                  child: InkWell(
                    onTap: () {
                      if (imageSelectedByte.length > 0) {
                        ...
                        Fluttertoast.showToast(
                            msg:
                                "Veuillez joindre la preuve de transaction / capture d'écran.");
                      }
                    },
                    borderRadius: BorderRadius.circular(30),
                    child: const Padding(
