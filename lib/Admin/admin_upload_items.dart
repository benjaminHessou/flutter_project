    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        if (resBodyOfUploadItem['success'] == true) {
          Fluttertoast.showToast(msg: "Nouvel élément téléchargé avec succès");
          ...
          Fluttertoast.showToast(
              msg: "Article non téléchargé. Erreur, réessayez.");
        }
      } else {
                      ...
                      child: Column(
                        children: [
                          ...
                          TextFormField(
                            ...
                            validator: (val) =>
                                val == "" ? "Veuillez entrez la taille" : null,
                            decoration: InputDecoration(
                              prefixIcon: const Icon(
                                Icons.picture_in_picture,
                                color: Colors.black,
                              ),
                              hintText: "Taille du Vêtement",
                              border: OutlineInputBorder(
                                borderRadius: BorderRadius.circular(30),
                                borderSide: const BorderSide(
                                  color: Colors.white60,
                          ...
                          TextFormField(
                            ...
                            decoration: InputDecoration(
                              ...
                              hintText: "La couleur du Vêtement",
                              border: OutlineInputBorder(
                                borderRadius: BorderRadius.circular(30),
                                borderSide: const BorderSide(
                                  color: Colors.white60,
